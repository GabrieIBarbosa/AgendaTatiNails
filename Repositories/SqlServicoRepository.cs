...
{
    public class SqlServicoRepository : DbConnection, IServicoRepository 
    {
        ...
        // Busca um serviço único no banco de dados pelo seu ID.
        ...
        // Busca uma lista de todos os serviços que estão ativos (status = 1).
        ...
        // Método auxiliar para converter uma linha do banco de dados em um objeto 'Servico'.
