...
{
    public class SqlHorarioRepository : DbConnection, IHorarioRepository 
    {
        ...
        // Busca o primeiro slot de horário associado a um atendimento (usado na página 'Editar').
        ...
        // Busca os horários disponíveis, garantindo que os slots existam (chama 'sp_GarantirHorariosParaData') e filtrando por slots consecutivos (lógica do 'WITH SlotsComJanela...').
