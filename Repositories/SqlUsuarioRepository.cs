...
{
    public class SqlUsuarioRepository : DbConnection, IUsuarioRepository 
    {
        ...
        // Busca um usuário no banco de dados pelo seu e-mail (usado para o login).
        ...
        // Busca um cliente e seus dados de usuário (nome, email) pelo ID.
        ...
        // Cadastra um novo cliente. Usa uma transação para salvar em 'Usuarios' e 'Clientes'.
        ...
        // Método auxiliar para converter uma linha do banco de dados em um objeto 'Usuario'.
